  ...
  return (
    <div className="container max-w-[1470px] mx-auto px-[15px] pb-24">
      ...
      <div className="grid grid-cols-[1fr_312px] gap-6">
        <CourseContainer setRemainingHour={setRemainingHour} setCreditHour={setCreditHour} remainingHour={remainingHour} setCoursesName={setCoursesName} courseNames={courseNames} setPrice={setPrice} />
